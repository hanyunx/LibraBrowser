...
_ACCOUNTSTATEWITHPROOF.fields_by_name['proof'].message_type = proto_dot_proof__pb2._ACCOUNTSTATEPROOF
...
AccountStateBlob = _reflection.GeneratedProtocolMessageType('AccountStateBlob', (_message.Message,), {
  ...
  '__module__' : 'proto.account_state_blob_pb2'
