...
_LEDGERINFO.fields_by_name['next_validator_set'].message_type = proto_dot_validator__set__pb2._VALIDATORSET
...
LedgerInfo = _reflection.GeneratedProtocolMessageType('LedgerInfo', (_message.Message,), {
  ...
  '__module__' : 'proto.ledger_info_pb2'
