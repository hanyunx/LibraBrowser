...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='proto/validator_change.proto',
  package='types',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=b'\n\x1cproto/validator_change.proto\x12\x05types\x1a\x17proto/ledger_info.proto\"d\n\x14ValidatorChangeProof\x12>\n\x15ledger_info_with_sigs\x18\x01 \x03(\x0b\x32\x1f.types.LedgerInfoWithSignatures\x12\x0c\n\x04more\x18\x02 \x01(\x08\x62\x06proto3'
  ,
  dependencies=[proto_dot_ledger__info__pb2.DESCRIPTOR,])
...
_VALIDATORCHANGEPROOF.fields_by_name['ledger_info_with_sigs'].message_type = proto_dot_ledger__info__pb2._LEDGERINFOWITHSIGNATURES
...
ValidatorChangeProof = _reflection.GeneratedProtocolMessageType('ValidatorChangeProof', (_message.Message,), {
  ...
  '__module__' : 'proto.validator_change_pb2'
