...
_UPDATETOLATESTLEDGERRESPONSE.fields_by_name['ledger_info_with_sigs'].message_type = proto_dot_ledger__info__pb2._LEDGERINFOWITHSIGNATURES
_UPDATETOLATESTLEDGERRESPONSE.fields_by_name['validator_change_proof'].message_type = proto_dot_validator__change__pb2._VALIDATORCHANGEPROOF
_UPDATETOLATESTLEDGERRESPONSE.fields_by_name['ledger_consistency_proof'].message_type = proto_dot_proof__pb2._ACCUMULATORCONSISTENCYPROOF
...
_GETACCOUNTSTATERESPONSE.fields_by_name['account_state_with_proof'].message_type = proto_dot_account__state__blob__pb2._ACCOUNTSTATEWITHPROOF
_GETACCOUNTTRANSACTIONBYSEQUENCENUMBERRESPONSE.fields_by_name['transaction_with_proof'].message_type = proto_dot_transaction__pb2._TRANSACTIONWITHPROOF
_GETACCOUNTTRANSACTIONBYSEQUENCENUMBERRESPONSE.fields_by_name['proof_of_current_sequence_number'].message_type = proto_dot_account__state__blob__pb2._ACCOUNTSTATEWITHPROOF
_GETEVENTSBYEVENTACCESSPATHREQUEST.fields_by_name['access_path'].message_type = proto_dot_access__path__pb2._ACCESSPATH
_GETEVENTSBYEVENTACCESSPATHRESPONSE.fields_by_name['events_with_proof'].message_type = proto_dot_events__pb2._EVENTWITHPROOF
_GETEVENTSBYEVENTACCESSPATHRESPONSE.fields_by_name['proof_of_latest_event'].message_type = proto_dot_account__state__blob__pb2._ACCOUNTSTATEWITHPROOF
_GETTRANSACTIONSRESPONSE.fields_by_name['txn_list_with_proof'].message_type = proto_dot_transaction__pb2._TRANSACTIONLISTWITHPROOF
...
UpdateToLatestLedgerRequest = _reflection.GeneratedProtocolMessageType('UpdateToLatestLedgerRequest', (_message.Message,), {
  ...
  '__module__' : 'proto.get_with_proof_pb2'
